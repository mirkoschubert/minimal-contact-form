...
# main config
PLUGINSLUG="minimal-contact-form"
CURRENTDIR=`pwd`
MAINFILE="mcf.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="https://plugins.svn.wordpress.org/minimal-contact-form/" # Remote SVN repo on wordpress.org, with trailing slash
SVNUSER="mirkoschubert" # your svn username

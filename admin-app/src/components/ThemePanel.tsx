    ...
    <Panel>
      <PanelBody title={__('Theme Settings', 'mcf')} initialOpen={true}>
        ...
        <div className="mcf-panel-group">
          ...
          />
          <p className="description">{__('Default theme matches v0.10.0 styling. Modern has rounded corners, Minimal is flat.', 'mcf')}</p>
        </div>
        ...
        <div className="mcf-panel-group">
          ...
          />
          <p className="description">{__('Choose between light and dark color schemes.', 'mcf')}</p>
        </div>
        ...
        <div className="mcf-panel-group">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Button onClick={() => setIsColorPickerOpen(!isColorPickerOpen)} style={{ position: 'relative' }}>

				...
				<div className="mcf-panel-group">
					...
					{!privacyPage?.exists && (
						<Notice status="warning" isDismissible={false}>
							...
							<p>
								{__('WordPress does not have a privacy page configured. This is required for GDPR compliance.', 'mcf')}
							</p>
							<p>
					...
					<ToggleControl
						label={__('Enable Honeypot Antispam', 'mcf')}
						checked={antispamEnabled}
						onChange={onAntispamChange}
						help={__('Uses an invisible honeypot field to prevent spam submissions without CAPTCHA.', 'mcf')}

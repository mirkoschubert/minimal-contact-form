...
export default function CSSEditor({ value, onChange, height = '450px' }: CSSEditorProps) {
  ...
  const mcfClasses = useMemo(() => ['.mcf-form', '.mcf-field', '.mcf-field-group', '.mcf-field-row', '.mcf-input', '.mcf-textarea', '.mcf-label', '.mcf-submit-button', '.mcf-gdpr', '.mcf-gdpr-checkbox', '.mcf-gdpr-label', '.mcf-notice', '.mcf-notice-success', '.mcf-notice-error', '.mcf-notice-warning'], [])

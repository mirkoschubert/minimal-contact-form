...
export default function App() {
    ...
    apiFetch({
      ...
      .catch((error: Error) => {
        ...
        setNotice({
          ...
          message:
            error.message ||
            __('Failed to save settings. Please try again.', 'mcf'),
        });
      });
  };
  ...
  const handleResetDatabase = () => {
    if (
      !confirm(
        __(
          '⚠️ WARNING: This will delete ALL settings and reset to v1.0.0 defaults!\n\nAre you sure?',
          'mcf'
        )
      )
    ) {
      ...
      <div className="mcf-admin-layout">
        ...
        <div className="mcf-admin-main">
          <FormPreview
            ...
            privacyTexts={
              settings.privacy_texts || { optin_text: '', inform_text: '' }
            }
